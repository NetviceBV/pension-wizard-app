...
const faqItems: { q: string; a: string | React.ReactNode; categories: FaqCategory[] }[] = [
  ...
  { q: "Wat moet ik doen bij een tussentijdse loonstijging?", a: "Bereken pgi en pt% voor periode 1. Vul deze gegevens in Mijn Apothekerspensioen, inclusief de start van de periode. Doe daarna hetzelfde voor periode 2 en geef in Mijn Apothekerspensioen ook aan wanneer periode 2 van start gaat.\n\nHeb je dit al eerder gedaan? Vul dan alleen de nieuwe gegevens in voor periode 2.", categories: ["loondienst"] },

...
const faqItems: { q: string; a: string | React.ReactNode; categories: FaqCategory[] }[] = [
  ...
  { q: "Wat vul ik in bij onbetaald verlof?", a: "Tijdens onbetaald verlof vindt geen pensioenopbouw plaats. U geeft daarom geen pensioengevend inkomen op voor deze periode. De risicodekkingen lopen tijdelijk door.", categories: ["loondienst", "dga", "zelfstandig"] },
  { q: "Wat vul ik in bij gedeeltelijk betaald verlof?", a: "U vult het daadwerkelijk ontvangen pensioengevend inkomen in. De pensioenopbouw wordt gebaseerd op het feitelijk verdiende inkomen, rekening houdend met uw parttimepercentage.", categories: ["loondienst", "dga", "zelfstandig"] },
  ...
  { q: "Wat moet ik doen bij een tussentijdse loonstijging?", a: "Bereken voor periode 1 het pensioengevend inkomen (PGI) en het parttimepercentage (PT%). Voer deze gegevens vervolgens in bij Mijn Apothekerspensioen en geef daarbij ook de startdatum van periode 1 op.\n\nHerhaal daarna dezelfde stappen voor periode 2 en registreer tevens de startdatum van periode 2 in Mijn Apothekerspensioen.\n\nHeb je de gegevens van periode 1 al eerder ingevoerd? Dan hoef je alleen nog het pensioengevend inkomen, het parttimepercentage en de startdatum van periode 2 in te vullen.", categories: ["loondienst"] },
